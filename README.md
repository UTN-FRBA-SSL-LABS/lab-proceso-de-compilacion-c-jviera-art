...
> **R:**Porque el prepocesador expande el #include<studio.h> copiando todo el contenido del header del sistema, que contiene cientos de declaraciones internas.
...
> **R:**Porque el preprocesador elimina todos los comentarios (/* */ y //) antes de pasarle el codigo al compilador.
...
> **R:**Sin -DDEBUG: no devuelve nada. Con -DDEBUG: printf("[DEBUG] %s\n", ("Iniciando main"));
...
> **R:**> Las líneas # N "archivo" indican de qué archivo proviene cada bloque de código. La declaración de printf proviene del archivo stdio.h ubicado en C:/TDM-GCC-64/x86_64-w64-mingw32/include/stdio.h
...
> **R:**sumar:    .globl sumar    .def sumar    .seh_proc sumar

Explicá en términos generales qué hacen esas instrucciones
(usá los comentarios del laboratorio como guía):

> **R:**Estas instrucciones declaran la funcion sumar como global y visible para el enlazador, y configuran el marco de pila para la función.
...
> **R:**0000000000000000 b .bss    0000000000000000 d .data    U _imp__acrt_iob_func    U __main    U __mingw_vfprintf    U area_circulo    U factorial    0000000000000195 T imprimir_separador    0000000000000000 B llamadas
...
> **R:**area_circulo tiene tipo U en programa.o porque programa.c solo la llama pero no la define. En matematica.o tiene tipo T porque ahí está su código implementado.
...
> **R:**Quedan porque son símbolos de la biblioteca dinámica del sistema que se cargan en tiempo de ejecución. Los resuelve el cargador dinámico de Windows cuando el programa se ejecuta.S
...
> **R:**La macro CUADRADO(x) se expande en tiempo de preprocesamiento y desaparece antes de que el compilador la vea, no tiene verificación de tipos. La función real sumar(a,b) existe en tiempo de compilación y enlazado, el compilador verifica los tipos de los argumentos.
...
> **R:**El símbolo T vive en la sección .text y representa código ejecutable (funciones). El símbolo D es la sección .data y representa variables globales con valor inicial.
